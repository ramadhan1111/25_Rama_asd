...
public class PencarianMahasiswa_25 {

    Mahasiswa_25 listMahasiswa[];
    int index;

    public PencarianMahasiswa_25(int jumlahMahasiswa) {
        listMahasiswa = new Mahasiswa_25[jumlahMahasiswa];
        index = 0;
    }

    void Tambah(Mahasiswa_25 m) {
    ...
    void Tampil() {
        for (Mahasiswa_25 m : listMahasiswa) {
            m.Tampil();
            System.out.println("============================================================");
        }
    }
    ...
    public void Tambah(MahasiswaMain_25 m) {
